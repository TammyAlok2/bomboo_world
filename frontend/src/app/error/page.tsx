...
export const metadata: Metadata = {
  title: "Error Page | Bomboo World",
  description: "This is the Error Page for Bomboo World where you can find the error related to page not found and other errors related to the website.",
  // other metadata
};
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <Link
                  href="/"
                  className="px-8 py-3 text-base font-bold text-white duration-300 rounded-md bg-green-600 shadow-signUp hover:bg-green-700 hover:text-white md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
