import SharePost from "@/components/HomePage/Blog/SharePost";
import TagButton from '@/components/HomePage/Blog/TagButton'
...
export async function generateMetadata({ params }: BlogDetailsPageProps): Promise<Metadata> {
  ...
  if (!blog) {
    return {
      title: "Blog Not Found | Bomboo World",
    };
  }

  return {
    title: `${blog.title} | Bomboo World`,
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  <div
                    className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed prose prose-lg max-w-none dark:prose-invert"
