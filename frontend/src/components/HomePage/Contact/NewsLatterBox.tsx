...
const NewsLetterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-lg bg-white p-8 [box-shadow:0_0_0.5rem_0_lightgray] dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-5 border-b border-body-color border-opacity-25 pb-3 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Connect with us to get the latest updates on our products and services.
      </p>
